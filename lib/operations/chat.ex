defmodule OpenAi.Chat do
  ...
  **Starting a new project?** We recommend trying [Responses](/docs/api-reference/responses) 
  ...
  """
  @spec create_chat_completion(body :: OpenAi.Chat.Completion.CreateRequest.t(), opts :: keyword) ::
          {:ok,
           OpenAi.Chat.Completion.CreateResponse.t()
           | OpenAi.Chat.Completion.Stream.CreateResponse.t()}
  ...
  def delete_chat_completion(completion_id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :delete,
      response: [{200, {OpenAi.Chat.Completion.Deleted, :t}}],
      opts: opts
    })
  end
  ...
  def get_chat_completion_messages(completion_id, opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {OpenAi.Chat.Completion.MessageList, :t}}],
      opts: opts
    })
  end
  ...
  def list_chat_completions(opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {OpenAi.Chat.Completion.List, :t}}],
      opts: opts
    })
  end
