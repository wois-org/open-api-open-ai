defmodule OpenAi.Completion.CreateRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          logit_bias: OpenAi.Completion.CreateRequest.LogitBias.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      logit_bias: {OpenAi.Completion.CreateRequest.LogitBias, :t},
      logprobs: :integer,
      max_tokens: :integer,
      model:
